...
export type DashboardData = {
  ...
  lastQuotes: Array<QuoteNode>;
  lastSummaries: Array<SummaryNode>;
  wantedList: Array<UserNode>;
};
...
export type UserNode = Node & {
  ...
  bankAccountActivity: Array<BankAccountActivity>;
  ...
  lastName: Scalars['String'];
  lastTransactions: Array<BankAccountActivity>;
...
export type SignInMutation = { __typename?: 'Mutation', login?: { __typename?: 'LoginMutation', ok: boolean, token?: string | null | undefined, user?: { __typename?: 'UserNode', id: string, email: string, username: string } | null | undefined } | null | undefined };

export type DashboardQueryVariables = Exact<{ [key: string]: never; }>;


export type DashboardQuery = { __typename?: 'Query', dashboardData: { __typename?: 'DashboardData', wantedList: Array<{ __typename?: 'UserNode', id: string, balance: number, fullName: string }>, lastSummaries: Array<{ __typename?: 'SummaryNode', id: string, date: any, summaryType: SummarySummaryType }>, lastQuotes: Array<{ __typename?: 'QuoteNode', id: string, text: string, context?: string | null | undefined, tagged: Array<{ __typename?: 'UserNode', id: string, profilePicture?: string | null | undefined, initials: string }> }> } };
...
export type QuoteShallowQuery = { __typename?: 'Query', quote?: { __typename?: 'QuoteNode', id: string, text: string } | null | undefined };
...
export type QuoteQuery = { __typename?: 'Query', quote?: { __typename?: 'QuoteNode', id: string, text: string, context?: string | null | undefined } | null | undefined };

export type MeQueryVariables = Exact<{ [key: string]: never; }>;


export type MeQuery = { __typename?: 'Query', me?: { __typename?: 'UserNode', id: string, username: string, firstName: string, lastName: string, profilePicture?: string | null | undefined, fullName: string, initials: string, email: string, balance: number, biography: string, studyAddress: string, homeAddress: string, phone: string, lastTransactions: Array<{ __typename?: 'BankAccountActivity', name: string, amount: number, quantity: number, timestamp: any }> } | null | undefined };
...
export type UserQuery = { __typename?: 'Query', user?: { __typename?: 'UserNode', fullName: string, biography: string, homeAddress: string, studyAddress: string, phone: string, initials: string, profilePicture?: string | null | undefined } | null | undefined };
 ...
 * });
 */
export function useQuoteShallowQuery(baseOptions: Apollo.QueryHookOptions<QuoteShallowQuery, QuoteShallowQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<QuoteShallowQuery, QuoteShallowQueryVariables>(QuoteShallowDocument, options);
      }
export function useQuoteShallowLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<QuoteShallowQuery, QuoteShallowQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<QuoteShallowQuery, QuoteShallowQueryVariables>(QuoteShallowDocument, options);
        }
export type QuoteShallowQueryHookResult = ReturnType<typeof useQuoteShallowQuery>;
export type QuoteShallowLazyQueryHookResult = ReturnType<typeof useQuoteShallowLazyQuery>;
export type QuoteShallowQueryResult = Apollo.QueryResult<QuoteShallowQuery, QuoteShallowQueryVariables>;
